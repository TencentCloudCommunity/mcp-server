    ...
    1.  打开IDE的设置，找到 CodeBuddy 下的手动配置
        ...
        ```json
        {
            "mcpServers": {
                "cos-mcp": {
                    "type": "sse",
                    "url": "https://mcp-api.tencent-cloud.com/sse/77xxxxxxxxxxxx" // 云托管生成的 SSE URL 替换为自己的 token
                }
            }
        }
        ```
