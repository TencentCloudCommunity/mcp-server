...
| [tencentcloud-ocr-document-high](src/ocr-document-high) | Supports detection and recognition of text throughout the entire image, returning text box positions and text content.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11762) |
...
|  WeDataMCP | The WeData Unity Semantics MCP Server provides a foundation for quickly implementing intelligent data analytics agents, featuring robust data retrieval and query processing capabilities. | No Support |  [![tencent-dnspod](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11763) |
|  WebSearchMCP | MCP Internet Search is powered by Tencent Cloud's Web Search API, utilizing Sogou's search engine infrastructure. It provides intelligent search enhancement across the full spectrum of public internet resources, featuring an end-to-end pipeline from content indexing through retrieval to intelligent ranking. | No Support |  [![tencent-dnspod](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11764) |
...
| [TSF APPlicationManager MCP](src/tsf) | Application Management is a PaaS platform centered around applications and microservices, providing one-stop application lifecycle management capabilities and data-driven operational support. It offers multi-dimensional monitoring data for applications and services, helping enterprises create and manage cloud resources, enabling them to focus fully on their core business.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11769) |
| Tencent Cloud Elasticsearch MCP Server | Tencent Cloud Elasticsearch Service (ES) is a fully managed cloud-based massive data search and analysis service, featuring a high-performance proprietary kernel and integrated X-Pack. The MCP server based on Tencent Cloud ES provides query services for ES cluster index data.| No Support |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11766) |
| [TSE MCP](src/tse) | Registry and Configuration provides dynamic service discovery, distributed configuration management, and service governance capabilities for cloud-native applications in microservices and distributed scenarios. With features such as zero modification, seamless migration, and multi-language support, it helps businesses migrate to the cloud easily and rapidly.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11770) |
| [VectorDB MCP](src/vdb) | Tencent Cloud VectorDB is a fully managed, self-developed enterprise-grade distributed database service designed specifically for storing, retrieving, and analyzing multi-dimensional vector data.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11771) |
| [VPN MCP](src/vpn) | VPN Connections is a transmission service based on network tunneling technology that enables connectivity between local data centers and Tencent Cloud resources. It helps you quickly establish a secure, reliable, and encrypted channel over the Internet.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11772) |
| [VPC MCP](src/vpc) | Virtual Private Cloud (VPC) is a dedicated cloud network space built on Tencent Cloud that provides network services for your resources on Tencent Cloud, with complete logical isolation between different VPCs.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11773) |
| [PostgreSQL MCP](src/postgres) | TencentDB for PostgreSQL enables you to effortlessly set up, operate, and scale the most powerful open-source database PostgreSQL in the cloud.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11774) |
| [BI MCP](src/bi) | TencentCloud BI (Business Intelligence) provides comprehensive BI capabilities covering the entire workflow from data source integration and data modeling to data visualization and analysis. With simple drag-and-drop operations, you can complete complex report development, while supporting enterprise collaboration scenarios such as report sharing and distribution.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11775) |
| [CKafka MCP](src/ckafka) | TDMQ for CKafka is a distributed, high-throughput, and highly scalable messaging system that is 100% compatible with open-source Kafka API versions 2.4, 2.8, and 3.2.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11776) |
| [TCHouse-C MCP](src/cdwch) | Tencent Cloud TCHouse-C is an enterprise-grade cloud data warehouse service built on the open-source OLAP engine ClickHouse.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11777) |
| [EO MCP](src/teo) | TencentCloud EdgeOne (EO) Edge Security and Acceleration Platform leverages Tencent Cloud's globally distributed edge nodes to deliver comprehensive edge services including domain name resolution, intelligent acceleration for both static and dynamic content, and TCP/UDP Layer 4 acceleration.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11780) |
| [ES MCP](src/es) | Tencent Cloud Elasticsearch Service (ES) is a fully managed cloud-based massive data search and analytics service, featuring a high-performance proprietary kernel and integrated X-Pack capabilities.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11781) |
| [RocketMQ MCP](src/trocket) | TDMQ for RocketMQ (abbreviated as TDMQ RocketMQ) is a distributed, highly available message queue service.| [Install Go Source](#mcp-servers-with-go-source-you-can-typically) |  [![tencent-cdn](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11782) |
...
| Lighthouse MCP Server | An MCP (Model Context Protocol) server built on Tencent Cloud Lighthouse API for seamless AI model integration and cloud server management. | No Support |  [![tencent-lighthouse](https://cloud.tencent.com/favicon.ico)](https://cloud.tencent.com/developer/mcp/server/11473) |
...
1.  Cloud Configuration
    ...
    4.  Enter the required parameters and click **Connect Server** to create an SSE URL
    
        Fill in the required parameters, where `Region` is the location of the hosted service and `Bucket` is the name of the storage bucket for the hosted service. These can be obtained and purchased from [Tencent Cloud Object Storage](https://console.cloud.tencent.com/cos).
    
        Obtain or generate your SecretID and SecretKey from [API Key Management](https://console.cloud.tencent.com/cam/capi)
        ![alt text](./images/hosted-start/3-input-param.png)
        Please securely store the generated SSE URL and do not disclose it.
        ![alt text](./images/hosted-start/4-create-sse-url.png)

2.  Cloud Testing
    1.  Select the corresponding tool and click **Test**
        ![alt text](./images/hosted-start/5-test-online-1.png)
        The test results are shown in the image below, indicating that the online configuration was successful
        ![alt text](./images/hosted-start/6-test-online-2.png)
3.  IDE Configuration for Hosted Services, using CodeBuddy as an example
    1.  Open the IDE settings and find the manual configuration under CodeBuddy
        ![alt text](./images/hosted-start/7-codebuddy-settings.png)
        Add the MCP service configuration using the configuration generated by the cloud hosting service
        ```json
        {
            "mcpServers": {
                "cos-mcp": {
...
4.  Using Cloud-Hosted MCP Services in the IDE
    1.  In CodeBuddy, enter **Help me check what files are in my object storage** to use the COS MCP service

        **Note**: Select **Craft** mode, as chat mode will not call MCP services
...
3.  Use **tencent-cvm** as example, add **tencent-cvm** to your MCP client configuration
    ...
    Example configuration for TencentCloud MCP:
    ```json
    {
      "mcpServers":{
        "mcp-server-tapd": {
